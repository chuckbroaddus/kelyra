...
export const ASK_TOOL_POLICY: Record<string, AskToolPolicyEntry> = {
  ...
  calendar_search: { capability: 'calendar.read', need: 'own' },
  calendar_draft_event: { capability: 'calendar.write', need: 'own' },
};
...
const ASK_CAPABILITY_DEFAULTS: GrantMap = {
  ...
  'calendar.read': { superintendent: 'school', administrator: 'school', teacher: 'own', parent: 'own', student: 'own' },
  'calendar.write': { superintendent: 'school', administrator: 'school', teacher: 'own', parent: 'own', student: 'own' },
  ...
  'classes.delete': { superintendent: 'school', administrator: 'school', teacher: 'none', parent: 'none', student: 'none' },
  'accounts.create': { superintendent: 'all', administrator: 'school', teacher: 'none', parent: 'none', student: 'none' },
  'accounts.hats': { superintendent: 'all', administrator: 'school', teacher: 'none', parent: 'none', student: 'none' },
  'school.matrix': { superintendent: 'all', administrator: 'none', teacher: 'none', parent: 'none', student: 'none' },
  'school.identity': { superintendent: 'all', administrator: 'none', teacher: 'none', parent: 'none', student: 'none' },
