-- Hotfix: messageable when student has login AND at least one linked parent has a
-- login (not every parent). Include all parents who have logins; skip parents without.
-- Still refuse if no parents linked OR zero parent logins OR no student login.
-- Dual-hat teacher-parent still OK (n >= 2). CoS already applied live 2026-09-11.
