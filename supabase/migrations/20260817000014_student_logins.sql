-- Every roster student is a person: provision a login and link profiles.student_id.
-- handle_new_user still inserts a leftover teachers row — this strips it for students.
...
-- Create logins for everyone already on a roster. Result grid = handles and one-time passwords.
