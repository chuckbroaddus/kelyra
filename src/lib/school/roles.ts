...
export const PERMISSION_MATRIX: Array<{
  ...
  { capability: 'Add roster name (not a login)', superintendent: 'Yes', administrator: 'Yes', teacher: 'Enroll existing (own classes)', parent: 'No', student: 'No' },
  ...
  { capability: 'Add a child / invent a student', superintendent: 'Creates accounts', administrator: 'Creates accounts', teacher: 'No — office only', parent: 'No', student: 'No' },
