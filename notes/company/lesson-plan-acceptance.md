...
> **R2 research/plan refresh 2026-09-24:** Product research/plan SoT updated in `notes/company/lesson-plan-research.md` + `notes/company/lesson-plan-plan.md` (and dated digest under `notes/research/`). This acceptance file remains the future loop contract; not a Build send.
